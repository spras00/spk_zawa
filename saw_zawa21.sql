...
CREATE TABLE `crips` (
  ...
  PRIMARY KEY (`id_cp`),
  KEY `id_k` (`id_k`),
  CONSTRAINT `crips_ibfk_1` FOREIGN KEY (`id_k`) REFERENCES `kriteria` (`id_k`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `r_altrumah` (
  ...
  KEY `id_a` (`id_a`),
  KEY `id_k` (`id_k`),
  CONSTRAINT `r_altrumah_ibfk_1` FOREIGN KEY (`id_a`) REFERENCES `altrumah` (`id_a`),
  CONSTRAINT `r_altrumah_ibfk_2` FOREIGN KEY (`id_k`) REFERENCES `kriteria` (`id_k`)
